...
export class FacturasService {
  ...
  getCobros(id: number): Observable<any[]> { return this.http.get<any[]>(`${this.apiUrl}/${id}/cobros`); }
  addCobro(id: number, data: any): Observable<any> { return this.http.post<any>(`${this.apiUrl}/${id}/cobros`, data); }
